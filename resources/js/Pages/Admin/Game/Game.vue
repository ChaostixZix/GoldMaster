<template>
    <App topnav="List Game">
        <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <Datatable hide-header="false" :columns="columns" :sortKey="sortKey"
                                            ...
                                            <tr v-for="p in paginated" role="row" class="odd">
                                                ...
                                                <td>{{ p.kategori }}</td>
                                                <td>
                                                    <button v-on:click="hapus(p.id_kategori)"
            ...
            <div class="col-12">
                <TambahGame v-if="tambah"></TambahGame>
            </div>
        </div>
    </App>
</template>
...
<script>
    ...
    import TambahGame from "./TambahGame";

    export default {
        components: {TambahGame, Messages, App, Pagination, Datatable},
        props: {
            game: Array
        },
        mounted() {
        ...
        methods: {
            hapus(id) {
                this.$inertia.post(this.$route('admin.game.delete', {id: id}), {}, {
                    replace: true,
                    preserveState: false,
