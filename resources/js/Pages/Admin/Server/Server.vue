<template>
    <App topnav="List Server">
        <div class="row">
            ...
            <div class="col-12">
                <TambahServer v-if="tambah"></TambahServer>
            </div>
        </div>
    </App>
</template>
...
<script>
    ...
    import TambahServer from "./TambahServer";

    export default {
        components: {TambahServer, Messages, App, Pagination, Datatable},
        props: {
            server: Array
        },
        mounted() {
