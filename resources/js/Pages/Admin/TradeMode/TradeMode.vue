<template>
    <App topnav="List Trade Mode">
        <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <Datatable hide-header="false" :columns="columns" :sortKey="sortKey"
                                            ...
                                            <tr v-for="p in paginated" role="row" class="odd">
                                                ...
                                                <td>{{ p.pengiriman }}</td>
                                                <td>
                                                    <button v-on:click="hapus(p.id_pengiriman)"
            ...
            <div class="col-12">
                <TambahTradeMode v-if="tambah"></TambahTradeMode>
            </div>
        </div>
    </App>
</template>
...
<script>
    ...
    import TambahTradeMode from "./TambahTradeMode";

    export default {
        components: {TambahTradeMode, Messages, App, Pagination, Datatable},
        props: {
            trademode: Array
        },
        mounted() {
