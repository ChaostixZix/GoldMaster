...
{{--                <div class="search-item">--}}
{{--                    <a href="#">--}}
{{--                        <img class="mr-3 rounded" width="30" src="{{ asset('stisla/assets') }}/img/products/product-3-50.png"--}}
{{--                             alt="product">--}}
...
{{--                <div class="search-item">--}}
{{--                    <a href="#">--}}
{{--                        <img class="mr-3 rounded" width="30" src="{{ asset('stisla/assets') }}/img/products/product-2-50.png"--}}
{{--                             alt="product">--}}
{{--                        Drone X2 New Gen-7--}}
{{--                    </a>--}}
{{--                </div>--}}
{{--                <div class="search-item">--}}
{{--                    <a href="#">--}}
{{--                        <img class="mr-3 rounded" width="30" src="{{ asset('stisla/assets') }}/img/products/product-1-50.png"--}}
{{--                             alt="product">--}}
{{--                        Headphone Blitz--}}
{{--                    </a>--}}
{{--                </div>--}}
...
{{--        </li>--}}
        @if(\Illuminate\Support\Facades\Session::has('admin'))
            <li class="dropdown"><a href="#" data-toggle="dropdown"
                    ...
                    <div class="d-sm-none d-lg-inline-block">Hi, {{\Illuminate\Support\Facades\Session::get('admin')}}</div>
                </a>
